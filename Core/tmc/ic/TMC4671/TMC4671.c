...
int32_t tmc4671_SimpleABNEncoderInit(uint32_t encNumber, uint32_t ABN_PPR, uint32_t ABN_count, int32_t ABN_phi_offset)
{
	if (encNumber == 1)	{
		tmc4671_writeInt(0, TMC4671_ABN_DECODER_PPR, ABN_PPR);
		tmc4671_writeInt(0, TMC4671_ABN_DECODER_COUNT, ABN_count);
		tmc4671_writeInt(0, TMC4671_ABN_DECODER_PHI_E_PHI_M_OFFSET, ABN_phi_offset);
		return 1;

	} else if (encNumber == 2) {
		tmc4671_writeInt(0, TMC4671_ABN_2_DECODER_PPR, ABN_PPR);
		tmc4671_writeInt(0, TMC4671_ABN_2_DECODER_COUNT, ABN_count);
		tmc4671_writeInt(0, TMC4671_ABN_2_DECODER_PHI_M_OFFSET  , ABN_phi_offset);
		return 1;
