...
C_SRCS += \
../Core/tmc/tmc4671_template.c 

C_DEPS += \
./Core/tmc/tmc4671_template.d 

OBJS += \
./Core/tmc/tmc4671_template.o 


# Each subdirectory must supply rules for building sources it contributes
Core/tmc/%.o Core/tmc/%.su Core/tmc/%.cyclo: ../Core/tmc/%.c Core/tmc/subdir.mk
...
clean: clean-Core-2f-tmc

clean-Core-2f-tmc:
	-$(RM) ./Core/tmc/tmc4671_template.cyclo ./Core/tmc/tmc4671_template.d ./Core/tmc/tmc4671_template.o ./Core/tmc/tmc4671_template.su

.PHONY: clean-Core-2f-tmc
